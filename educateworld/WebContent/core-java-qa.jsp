<%@include file="header.jsp"%>
 ...
 -->
								...
								<nav><div id="acp_content" class="acp_content">
									<p>
									...
									<p>1. Java was invented by James Gosling in the year of
										...
										a secret project called ‚ÄúGreen‚Äù in Sun Micro System
										...
										decided to call his language "oak"Äù. 3. In 1992, they
										developed and delivered product called Äú*7Äù it was an
										extremely intelligent remote control. 4. In 1995 "oak"Äù was
										renamed as "java"Äù because of some legal problems. The main
									...
									<p>
										<b>Simple and Small:</b> Java is a simple and small language
										...
										implement a network based application. Java system doesn'Äôt
									...
									<p>
										<b>Object Oriented Programming Language:</b> <br> Object
									...
									<p>
										...
										methods (Behavior) of a class are defined inside a class body.
									...
									<p>
										...
										optional< > - are mandatory (must) <br>Syntax:
										...
										is contained with in a method. <br> Ex: <br>
										ObjectDemo.java <br> <br> class Emp <br> { <br>
										...
										e.sal=20000.00; <br> e.desig="Faculty"Äù; <br>
										e.getEmpDetails(); <br> } <br> } <br>
										D:\java\javac ObjectDemo.java <br> D:\java\dir *.class <br>
										Emp.class <br> ObjectDemo.class <br> D:\java\java
										ObjectDemo <br> Output: <br> 101 <br> Naresh <br>
									...
									<p>
										<strong>What is String?</strong>
									</p>
									it is Non-mutable. Once you create string object provided with
...
Can we create user define marker interface?
